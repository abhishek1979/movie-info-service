package com.abhishek.movienfoservice.controller;
...
class FluxAndMonoControllerTest {
	...
	void flux_approach2() {
		...
		var flux = webTestClient.get().uri("/flux").exchange().expectStatus().is2xxSuccessful()
	...
	void stream() {
		...
		var flux = webTestClient.get().uri("/stream").exchange().expectStatus().is2xxSuccessful()
